...
- New Work Item lifecycle capabilities are not added to existing baseline grants automatically. Only an actor explicitly granted the capability through the existing trusted grant owner issuance path may execute it; do not reissue grants to expand access. A general Agent grant API remains a Slice 7 capability.
