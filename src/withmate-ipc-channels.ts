...
export const WITHMATE_OPEN_MEMORY_MANAGEMENT_WINDOW_CHANNEL = "withmate:open-memory-management-window";
export const WITHMATE_OPEN_MATE_TALK_WINDOW_CHANNEL = "withmate:open-mate-talk-window";
...
export const WITHMATE_GET_MATE_GROWTH_SETTINGS_CHANNEL = "withmate:get-mate-growth-settings";
export const WITHMATE_UPDATE_MATE_GROWTH_SETTINGS_CHANNEL = "withmate:update-mate-growth-settings";
...
export const WITHMATE_SEARCH_COMPANION_WORKSPACE_FILES_CHANNEL = "withmate:search-companion-workspace-files";
...
export const WITHMATE_CORRECT_MATE_GROWTH_EVENT_CHANNEL = "withmate:correct-mate-growth-event";
export const WITHMATE_DISABLE_MATE_GROWTH_EVENT_CHANNEL = "withmate:disable-mate-growth-event";
export const WITHMATE_FORGET_MATE_GROWTH_EVENT_CHANNEL = "withmate:forget-mate-growth-event";
