...
export const WITHMATE_LIST_SESSION_COORDINATION_EVENTS_CHANNEL = "withmate:list-session-coordination-events";
export const WITHMATE_GET_SESSION_COORDINATION_EVENT_CHANNEL = "withmate:get-session-coordination-event";
export const WITHMATE_RESOLVE_SESSION_COORDINATION_EVENT_CHANNEL = "withmate:resolve-session-coordination-event";
export const WITHMATE_CANCEL_SESSION_COORDINATION_EVENT_CHANNEL = "withmate:cancel-session-coordination-event";
