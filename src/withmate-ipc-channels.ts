...
export const WITHMATE_GET_AUXILIARY_CREATION_CONTEXT_CHANNEL = "withmate:get-auxiliary-creation-context";
export const WITHMATE_CANCEL_AUXILIARY_CREATION_CHANNEL = "withmate:cancel-auxiliary-creation";
export const WITHMATE_GET_AUXILIARY_CREATION_CHANNEL = "withmate:get-auxiliary-creation";
...
export const WITHMATE_SESSION_DRAFT_FLUSH_REQUEST_EVENT = "withmate:session-draft-flush-request";
export const WITHMATE_SESSION_DRAFT_FLUSH_ACK_CHANNEL = "withmate:session-draft-flush-ack";
export const WITHMATE_SESSION_DRAFT_FLUSH_RELEASE_EVENT = "withmate:session-draft-flush-release";
