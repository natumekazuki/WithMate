...
export function useSessionChatShellFeature(input: {
  ...
  const buildSurface = (content: {
    ...
    leftSplitterProps: {
      ...
      ariaLabel: input.sidePanes.isFilesPaneVisible ? "Collapse File explorer" : "Open File explorer",
      title: "Click to toggle File explorer. Drag or use arrow keys to resize when expanded.",
    },
