...
function rowToSession(row: CompanionSessionRow): CompanionSession {
  return {
    ...
    codexReviewer: normalizeCodexReviewer(row.codex_reviewer),
...
export class CompanionStorage {
  ...
  constructor(dbPath: string) {
    ...
    this.db.exec(`
      ...
      CREATE TABLE IF NOT EXISTS companion_sessions (
        ...
        codex_reviewer TEXT NOT NULL DEFAULT '${DEFAULT_CODEX_REVIEWER}',
  ...
  private ensureSchema(): void {
    ...
    if (!columns.has("allowed_additional_directories_json")) {
      this.db.exec("ALTER TABLE companion_sessions ADD COLUMN allowed_additional_directories_json TEXT NOT NULL DEFAULT '[]';");
    }
