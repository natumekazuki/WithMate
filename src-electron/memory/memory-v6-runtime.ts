...
} from "../platform/memory/memory-discovery.js";
import {
...
} from "../platform/memory/memory-runtime-exchange.js";
import {
  isUuid,
...
} from "../platform/runtime-discovery/runtime-discovery-contract.js";
import {
...
} from "../platform/runtime-discovery/runtime-discovery-registry.js";
...
import type { AgentRuntimeBindingRegistry } from "../providers/agent-runtime-binding.js";
import type { ProviderAgentRuntimeTurnCoordinator } from "../providers/provider-agent-runtime-turn-coordinator.js";
import {
...
import { CharacterAffectStorage } from "../character/character-affect-storage.js";
import type { StorageOperationDiagnosticSink } from "../storage/storage-operation-diagnostics.js";
import { createCharacterAffectServiceWithMemory } from "../character/character-affect-memory-adapter.js";
import { CharacterContextApplicationService } from "../character/character-context-application-service.js";
...
import { secureWindowsRuntimePath } from "../platform/runtime-path-security.js";
...
export async function startMemoryV6RuntimeApi(
  ...
  try {
    ...
    const workerEntry = new URL(
      import.meta.url.endsWith(".ts") ? "../storage/storage-worker-entry.ts" : "../storage/storage-worker-entry.js",
      import.meta.url,
    );
