...
import { isMessageRenderedSearchTextNode } from "../../src/chat/conversation/message-rendered-search-text.js";
...
// @test-value v2
// kind = "contract"
// claim = "glossary tooltipは非interactiveで最大360x240に収まり、tooltip自身をscroll ownerにしない"
// oracle = { type = "contract", ref = "src/chat/session.css" }
// fault = "glossary tooltipがpointer eventを奪う、画面内で過大化する、またはtooltip自身のscrollを要求する"
// observable = "tooltipとdefinitionのCSS position・size・overflow・pointer-events rule"
// observation_boundary = "consumer"
// scope = "message glossary annotation tooltip layout"
// lifecycle = "permanent"
// @end-test-value
