...
import { buildAuditLogRefreshSignature, buildDisplayedAuditLogs } from "../../src/chat/runtime/audit-log-refresh.js";
...
describe("buildDisplayedAuditLogs", () => {
  ...
  // oracle = { type = "contract", ref = "src/chat/runtime/audit-log-refresh.ts" }
