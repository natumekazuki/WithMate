...
describe("approval mode helpers", () => {
  ...
  // @test-value v2
  // kind = "contract"
  // claim = "default approval modeはprovider-neutralなsentence-caseの英語表示labelを返す"
  // oracle = { type = "contract", ref = "src-shared/settings/approval-mode.ts#approvalModeLabel" }
