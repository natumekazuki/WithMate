...
import {
  ...
  toAffectEventInputs,
} from "../../src-electron/character/character-affect-turn-evaluator.js";
...
describe("character affect turn evaluator", () => {
  ...
  // oracle = { type = "adr", ref = "docs/adr/024-provider-common-memory-mcp-boundary.md; src-electron/character/character-affect-turn-evaluator.ts#buildCharacterAffectTurnPrompt" }
  ...
  it("one-turn eventと最小contextだけを評価promptへ渡す", () => {
    ...
    assert.doesNotMatch(prompt.userText, /memory-secret|Private title|Private preview/);
