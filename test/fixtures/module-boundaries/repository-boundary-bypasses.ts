...
const structuralUpdateSessionTitle = localWritePort.updateSessionTitle!({});
const structuralTransitionSession = localWritePort.transitionSession!({});
const structuralDeleteSessionSubtree = localWritePort.deleteSessionSubtree!({});
const structuralCompleteSessionDeletionCleanup = localWritePort.completeSessionDeletionCleanup!({});
...
void structuralUpdateSessionTitle;
void structuralTransitionSession;
void structuralDeleteSessionSubtree;
void structuralCompleteSessionDeletionCleanup;
