...
このreview setでは、14 table、状態遷移、transaction境界、crash recovery、明示削除、Provider相関を確定範囲とする。DDL / versioned migration、Persistence Worker / repository API、Application Service / CLIの具体型、contract test実装、自動retention、Copilot ACP runtime mappingは次段階で扱う。
