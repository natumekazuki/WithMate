...
- plan tier: repo plan
- 状態: active
- 現在地: CP1完了。CP2 Application Service / CLI Control Plane進行中
...
| CP2 | Application Service / CLI Control Plane | 進行中 | Session / Message / Run履歴、Run観測・output、error envelope、CLI基本操作 | CP1 |
