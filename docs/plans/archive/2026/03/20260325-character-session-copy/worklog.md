...
- 2026-03-25: plan 作成。SessionWindow の固定文言、character storage、Character Editor の current 実装を確認した。
- 2026-03-25: `CharacterProfile.sessionCopy` と bland default copy を app state / character storage に追加した。
