...
- commit `cd5dd1e` `feat(session): add responsive guardrails`
  - checkpoint: minimum window bounds、Session / Diff responsive guardrail、attachment overflow guardrail、design / checklist / backlog 同期
