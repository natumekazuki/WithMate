...
- plan tier: repo plan
- 状態: active
- 現在地: S6進行中、B4 initial child admissionとC RunOutput / terminal / child result collect完了。次はD Session subtree delete / startup repair
...
| S6    | Repository Write Transactions          | 進行中（B / C完了、D残）  | admission、terminal、output、binding / dispatch、delivery、delete                  | S4、S5 |
