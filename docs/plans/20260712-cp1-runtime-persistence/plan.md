...
- plan tier: repo plan
- 状態: active
- 現在地: S6進行中、B2 Binding / Dispatch transition完了
...
| S6 | Repository Write Transactions | 進行中（B2完了） | admission、terminal、output、binding / dispatch、delivery、delete | S4、S5 |
...
- B: Run admission、Attempt / Binding / Dispatch、supplemental input（B1 通常Run admission、B2 Binding / Dispatch transition、B3 retry / supplemental input完了）
