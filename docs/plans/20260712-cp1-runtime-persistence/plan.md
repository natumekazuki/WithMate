...
- plan tier: repo plan
- 状態: active
- 現在地: S6進行中、B1 通常Run admission完了
...
| S6 | Repository Write Transactions | 進行中（B1完了） | admission、terminal、output、binding / dispatch、delivery、delete | S4、S5 |
...
- B: Run admission、Attempt / Binding / Dispatch、supplemental input（B1 通常Run admission完了）
