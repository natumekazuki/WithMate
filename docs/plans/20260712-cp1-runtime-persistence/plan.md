...
- plan tier: repo plan
- 状態: active
- 現在地: S6進行中、C RunOutput / terminal / child result collect完了。次はB4 child / Auxiliary admission入口
...
| S6    | Repository Write Transactions          | 進行中（C完了、B4 / D残） | admission、terminal、output、binding / dispatch、delivery、delete                  | S4、S5 |
...
- B: Run admission、Attempt / Binding / Dispatch、supplemental input（B1 通常Run admission、B2 Binding / Dispatch transition、B3 retry / supplemental input完了、B4 child / Auxiliary admission入口は残）
