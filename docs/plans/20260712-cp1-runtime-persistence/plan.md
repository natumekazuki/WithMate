...
- plan tier: repo plan
- 状態: active
- 現在地: S6進行中、A typed command / Session操作完了
...
| S6 | Repository Write Transactions | 進行中（A完了） | admission、terminal、output、binding / dispatch、delivery、delete | S4、S5 |
...
- B: Run admission、Attempt / Binding / Dispatch、supplemental input
