...
現行Session control planeのcommand名とstructured outputはADR 006、public type、CLI help、contract testを正本とする。以下は後続CP2 scopeを含め、Application Serviceが段階的に提供する操作を示す。
