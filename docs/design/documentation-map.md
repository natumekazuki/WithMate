...
| `character-definition-format.md` | V5 Core 用に縮小更新して `character.md` / `character-notes.md` format 正本へ戻す候補 |
| `character-storage.md` | V5 Core 用に更新して SQLite metadata + file body + session snapshot の storage 正本へ戻す候補 |
