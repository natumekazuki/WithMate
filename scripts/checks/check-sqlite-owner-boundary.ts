...
const allowed = path.resolve("src-electron/storage/sqlite-connection.ts");
...
if (violations.length > 0) {
  console.error("node:sqlite runtime imports must be limited to src-electron/storage/sqlite-connection.ts:");
