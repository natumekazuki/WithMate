...
const names = [
  ...
  "updateChatLayoutPreference", "previewCompanionComposerInput",
  "listCompanionSessionSummaries", "getCompanionSession", "subscribeCompanionSessionSummaries",
  "subscribeOpenCompanionReviewWindowIds", "subscribeOpenSessionWindowIds", "subscribeSessionWindowRestoreSet",
  "subscribeProviderQuotaTelemetry", "subscribeSessionContextTelemetry", "subscribeSessionBackgroundActivity",
  "listOpenCompanionReviewWindowIds", "listOpenSessionWindowIds", "getSessionWindowRestoreSet",
