...
export const SESSION_MCP_TOOL_DEFINITIONS = [
  ...
  { name: "coordination.event.create", title: "Create coordination event", description: "Record a public coordination event for the bound Session.", readOnly: false, destructive: false },
