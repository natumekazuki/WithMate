...
test("resolveChatWindowModeFromSearch は mate-talk window を優先して解決する", () => {
  assert.deepEqual(resolveChatWindowModeFromSearch("?sessionId=session-1&companionSessionId=companion-1&mode=mate-talk"), {
    kind: "mate-talk",
  });
});
