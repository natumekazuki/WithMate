...
// @test-value v1
// kind = "contract"
// claim = "Glossary注釈はMarkdown parse後の通常textだけへ付き本文と検索文字列を変えない"
// oracle = { type = "contract", ref = "docs/features/repository-glossary.md" }
// failure_mode = "codeやlink構造を注釈で壊すか検索対象文字列を変える"
// scope = "MessageRichText glossary annotation projection"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "invariant"
// claim = "light renderからfull renderへ移行しても数式projectionをGlossary注釈対象にしない"
// oracle = { type = "contract", ref = "docs/features/repository-glossary.md" }
// failure_mode = "数式の表示文字列へterm注釈が入り数式DOMを破壊する"
// scope = "MessageRichText glossary annotation exclusions"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "contract"
// claim = "message内Glossary termはroving focus、tooltip、canonical term activationを提供する"
// oracle = { type = "contract", ref = "docs/features/repository-glossary.md" }
// failure_mode = "keyboardでterm間を移動できないかaliasから誤ったentryを開く"
// scope = "MessageRichText glossary keyboard interaction"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "contract"
// claim = "Glossary tooltipは非interactiveで最大360x240に収まり独立scroll領域を作らない"
// oracle = { type = "contract", ref = "docs/features/repository-glossary.md" }
// failure_mode = "tooltipがfocusを奪うか入れ子scrollを作ってmessage操作を妨げる"
// scope = "Glossary tooltip presentation"
// lifecycle = "permanent"
// @end-test-value
