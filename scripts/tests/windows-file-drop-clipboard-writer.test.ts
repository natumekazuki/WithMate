...
// @test-value v1
// kind = "regression"
// claim = "test declaration at line 23 preserves its observable contract"
// oracle = { type = "contract", ref = "-23" }
// failure_mode = "line 23 violates its expected output or boundary behavior"
// scope = "windows-file-drop-clipboard-writer.test"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "regression"
// claim = "test declaration at line 35 preserves its observable contract"
// oracle = { type = "contract", ref = "-35" }
// failure_mode = "line 35 violates its expected output or boundary behavior"
// scope = "windows-file-drop-clipboard-writer.test"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "regression"
// claim = "test declaration at line 50 preserves its observable contract"
// oracle = { type = "contract", ref = "-50" }
// failure_mode = "line 50 violates its expected output or boundary behavior"
// scope = "windows-file-drop-clipboard-writer.test"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "regression"
// claim = "test declaration at line 68 preserves its observable contract"
// oracle = { type = "contract", ref = "-68" }
// failure_mode = "line 68 violates its expected output or boundary behavior"
// scope = "windows-file-drop-clipboard-writer.test"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "regression"
// claim = "test declaration at line 117 preserves its observable contract"
// oracle = { type = "contract", ref = "-117" }
// failure_mode = "line 117 violates its expected output or boundary behavior"
// scope = "windows-file-drop-clipboard-writer.test"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "regression"
// claim = "test declaration at line 131 preserves its observable contract"
// oracle = { type = "contract", ref = "-131" }
// failure_mode = "line 131 violates its expected output or boundary behavior"
// scope = "windows-file-drop-clipboard-writer.test"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "regression"
// claim = "test declaration at line 142 preserves its observable contract"
// oracle = { type = "contract", ref = "-142" }
// failure_mode = "line 142 violates its expected output or boundary behavior"
// scope = "windows-file-drop-clipboard-writer.test"
// lifecycle = "permanent"
// @end-test-value
