...
// @test-value v1
// kind = "contract"
// claim = "History一覧は専用scroll root内のsentinel交差ごとに次pageを一度だけ取得する"
// oracle = { type = "contract", ref = "docs/features/git-history-and-commit-preview.md" }
// failure_mode = "同じsentinel交差で重複取得するか手動Load more操作を要求する"
// scope = "file-root Git history pagination"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "regression"
// claim = "History追加page取得の失敗後も既存commitを保持し、sentinelから再試行できる"
// oracle = { type = "contract", ref = "docs/features/git-history-and-commit-preview.md" }
// failure_mode = "追加取得失敗で既存一覧が消えるか再試行不能になる"
// scope = "file-root Git history pagination recovery"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "contract"
// claim = "Historyはrepository未検出とcommitなしを異なるempty stateとして表示する"
// oracle = { type = "contract", ref = "docs/features/git-history-and-commit-preview.md" }
// failure_mode = "利用者がrepository探索失敗と履歴なしを区別できない"
// scope = "file-root Git history empty-state projection"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "invariant"
// claim = "repository切り替え後のHistoryは旧pageを破棄し新repositoryの先頭pageだけを表示する"
// oracle = { type = "contract", ref = "docs/features/git-history-and-commit-preview.md" }
// failure_mode = "旧repositoryのcommitが新repositoryの一覧へ混入する"
// scope = "file-root Git history repository selection"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "regression"
// claim = "repository一覧の再読込開始時点で選択中の旧Diffを表示対象から外す"
// oracle = { type = "contract", ref = "docs/features/git-history-and-commit-preview.md" }
// failure_mode = "repository構成の更新中に旧repositoryのDiffを現行情報として表示する"
// scope = "file-root Git history refresh invalidation"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "invariant"
// claim = "遅延したcommit detail応答は現在選択中のcommit detailを上書きしない"
// oracle = { type = "contract", ref = "docs/features/git-history-and-commit-preview.md" }
// failure_mode = "古い非同期応答が別commitのmetadataやchanged filesとして表示される"
// scope = "file-root Git history commit-detail request generation"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "invariant"
// claim = "Back操作後に完了した旧file Diff応答はcommit detail画面へ混入しない"
// oracle = { type = "contract", ref = "docs/features/git-history-and-commit-preview.md" }
// failure_mode = "画面遷移前のDiffが戻り先のcommit detailを上書きする"
// scope = "file-root Git history file-diff request generation"
// lifecycle = "permanent"
// @end-test-value
