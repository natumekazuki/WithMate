...
// @test-value v1
// kind = "security"
// claim = "認可済みregular fileだけをcanonical real pathでnative writerへ渡す"
// oracle = { type = "contract", ref = "docs/features/windows-file-object-copy.md" }
// failure_mode = "未認可pathやsymlink表記のままnative file objectを書き込む"
// scope = "session-file-object-copy-authorization"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "security"
// claim = "認可・存在・regular file検証のいずれかが失敗した場合はnative writerを開始しない"
// oracle = { type = "contract", ref = "docs/features/windows-file-object-copy.md" }
// failure_mode = "事前検証失敗後にもnative clipboard writeが開始される"
// scope = "session-file-object-copy-preflight"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "invariant"
// claim = "native write開始前の失敗と開始後に結果を確認できない状態を別statusで返す"
// oracle = { type = "contract", ref = "docs/features/windows-file-object-copy.md" }
// failure_mode = "副作用certaintyを混同し、安全な再試行可否を利用者が判断できない"
// scope = "session-file-object-copy-effect-certainty"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "security"
// claim = "Markdown linkはMain側の解決結果がfile resourceの場合だけcopy対象になる"
// oracle = { type = "contract", ref = "docs/features/markdown-rendering-and-code-actions.md" }
// failure_mode = "directory・外部URL・未解決linkがfile object copyへ到達する"
// scope = "markdown-link-file-object-copy-resolution"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "security"
// claim = "Markdown link由来のroot外absolute-file resourceはCopy File対象にしない"
// oracle = { type = "contract", ref = "docs/features/windows-file-object-copy.md" }
// failure_mode = "Markdown contentからworkspace外fileをnative clipboardへ書き込める"
// scope = "markdown-link-file-object-copy-boundary"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "invariant"
// claim = "利用者が現在表示中のabsolute-file previewで明示したCopy Fileは許可する"
// oracle = { type = "contract", ref = "docs/features/windows-file-object-copy.md" }
// failure_mode = "正規のdetached previewでも明示Copy File操作が常に拒否される"
// scope = "file-preview-explicit-object-copy"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "invariant"
// claim = "複数Copy File operationを直列化し、各operationのnative writeとread-backを交差させない"
// oracle = { type = "contract", ref = "docs/features/windows-file-object-copy.md" }
// failure_mode = "後続copyが先行copyのread-backへ割り込み、誤ったfileの成功を返す"
...
// @test-value v1
// kind = "regression"
// claim = "context menu選択後はpopup close callbackよりCopy File結果を優先して返す"
// oracle = { type = "contract", ref = "docs/features/windows-file-object-copy.md" }
// failure_mode = "menu closeが先にsettleし、実行済みcopyをcanceledとして表示する"
// scope = "session-file-object-copy-context-menu-settlement"
// lifecycle = "permanent"
// @end-test-value
