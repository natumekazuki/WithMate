...
// @test-value v1
// kind = "invariant"
// claim = "Messages navigatorはaccessible nameを持つnative rowを上下キーとEnterで選択できる"
// oracle = { type = "contract", ref = "docs/features/session-message-collapse-and-navigation.md" }
// failure_mode = "keyboard利用者がmessage候補を移動・確定できない、またはcontrol名を認識できない"
// scope = "session-message-navigator-keyboard-accessibility"
// lifecycle = "permanent"
// @end-test-value
