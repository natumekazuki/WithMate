...
describe("WithMate Session MCP contract", () => {
  ...
  // fault = "HTTPまたはCLIにあるoperationがMCP tool一覧から欠落するか、generic envelope required fieldまたはreadOnly/destructive分類が分岐するか、Delegation create/retryの外部効果をopenWorldHintへ反映しない"
