...
// @test-value v1
// kind = "contract"
// claim = "先頭YAML frontmatterのscalar mappingはkey/value tableとしてPreview表示される"
// oracle = { type = "contract", ref = "docs/features/markdown-rendering-and-code-actions.md" }
// failure_mode = "frontmatterがraw Markdownのまま表示されるかkey/value対応が崩れる"
// scope = "MessageRichText frontmatter preview"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "contract"
// claim = "Source modeはYAML frontmatterを含む元Markdownを変換せず表示する"
// oracle = { type = "contract", ref = "docs/features/markdown-rendering-and-code-actions.md" }
// failure_mode = "Source表示でfrontmatter table化または文字列改変が起きる"
// scope = "MessageRichText frontmatter source mode"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "compatibility"
// claim = "table化できないfrontmatterはcode blockへfallbackしfrontmatterでない区切りを本文として保持する"
// oracle = { type = "contract", ref = "docs/features/markdown-rendering-and-code-actions.md" }
// failure_mode = "複雑YAMLを誤ってtable化するか本文のthematic breakをfrontmatterとして消費する"
// scope = "MessageRichText frontmatter fallback classification"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "contract"
// claim = "frontmatter Previewのtableとfallback codeは長い値をmessage幅内で折り返す"
// oracle = { type = "contract", ref = "docs/features/markdown-rendering-and-code-actions.md" }
// failure_mode = "長いfrontmatter値がmessage cardから横にはみ出す"
// scope = "MessageRichText frontmatter layout CSS"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "contract"
// claim = "copy操作はfenced code blockだけにaccessible name付きで表示される"
// oracle = { type = "contract", ref = "docs/features/markdown-rendering-and-code-actions.md" }
// failure_mode = "inline codeへ誤ったcopy操作を出すか支援技術から操作名を識別できない"
// scope = "MessageRichText code-block copy affordance"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "contract"
// claim = "render済みMarkdown linkのcontext menuは元targetをcopy処理へ渡し結果feedbackを表示する"
// oracle = { type = "contract", ref = "docs/features/markdown-rendering-and-code-actions.md" }
// failure_mode = "右clickしたlinkと異なるtargetをcopyするか完了状態が通知されない"
// scope = "MessageRichText link context-menu interaction"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "regression"
// claim = "単独Markdown list itemは余分なparagraph wrapperなしのliとして表示される"
// oracle = { type = "contract", ref = "docs/features/markdown-rendering-and-code-actions.md" }
// failure_mode = "不要なwrapperでnative list markerと本文のblock flowが分断される"
// scope = "MessageRichText list item rendering"
// lifecycle = "permanent"
// @end-test-value
...
// @test-value v1
// kind = "contract"
// claim = "browser初回のlight renderでも先頭YAML frontmatterが欠落せず表示される"
// oracle = { type = "contract", ref = "docs/features/markdown-rendering-and-code-actions.md" }
// failure_mode = "full rendererへの切替前だけfrontmatterが空白になる"
...
// @test-value v1
// kind = "contract"
// claim = "Mermaid code blockはdiagram containerとして表示し通常code copy操作を付けない"
// oracle = { type = "contract", ref = "docs/features/markdown-rendering-and-code-actions.md" }
// failure_mode = "diagram sourceを通常code blockとして扱いcopy操作を重複表示する"
// scope = "MessageRichText Mermaid rendering"
// lifecycle = "permanent"
// @end-test-value
