...
describe("database-schema-v6", () => {
  // @test-value v1
  // kind = "compatibility"
  // claim = "既存V6 Sessionを保持したままis_pinned列を追加し、既存rowをfalseへbackfillする"
  // oracle = { type = "contract", ref = "docs/features/home-session-pagination.md" }
  // failure_mode = "schema ensureが既存Sessionを失う、または追加列が未初期化となりHomeのpin状態を読めない"
  // scope = "database-schema-v6-session-pin-migration"
  // lifecycle = "permanent"
  // @end-test-value
  ...
  // @test-value v1
  // kind = "compatibility"
  // claim = "既存Affect eventの値を保持したままnullable family列と許可値CHECKを追加する"
  // oracle = { type = "contract", ref = "docs/features/cross-session-affect-afterglow.md" }
  // failure_mode = "migrationが既存eventを再分類・削除する、または不正familyを保存できるschemaを残す"
  // scope = "database-schema-v6-affect-family-migration"
  // lifecycle = "permanent"
  // @end-test-value
